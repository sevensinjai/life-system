...
app/
  ...
  models/              # User, Player, Quest, QuestInstance, Skill, Quote, Penalty, SystemEvent
  ...
  routers/             # health, auth, players, quests, skills, quotes, system
alembic/               # migrations
...
holds for `pick_for_day` in `services/quotes.py` and the tree arithmetic at the
